...
namespace MSRP
{
    ...
    public class Session
    {
        ...
        {
            if (contentType == null || contentType == string.Empty) { throw new IllegalUseException("No contentType given this is required!"); }
        ...
        public OutgoingMessage SendMessage(OutgoingMessage message)
        {
            ...
            if (message.HasData) { EndComposing(); }
        ...
        {
            return _messagesSentOrSending.Keys.Contains(messageID) ? _messagesSentOrSending[messageID] : null;
        }
        ...
        {
            return _messagesReceive.Keys.Contains(messageId) ? _messagesReceive[messageId] : null;
        }
